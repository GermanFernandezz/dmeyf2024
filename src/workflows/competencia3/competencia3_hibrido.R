...
kaggle_modelo_12 <- read.table("expw227_KA-0001_ganancias_log.txt", header = TRUE)[c(1:6),]
...
modelo_12 <- fread("expw227_SC-0001_tb_future_prediccion.txt", header = TRUE)


# Combino los modelos 1,3, 7 8 10 11 12 para hacer un híbrido
...
colnames(modelos_promedio) <- c("numero_de_cliente",
                                ...
                                "modelo_10",
                                "modelo_11")
modelos_promedio <- merge(modelos_promedio, modelo_12[,c(1,54)], by="numero_de_cliente")
colnames(modelos_promedio) <- c("numero_de_cliente",
                                "modelo_1",
                                "modelo_3",
                                "modelo_7",
...
kaggle_hibrido_9500_modelos_1_3_7_8_10_11_12 <- data.table(numero_de_cliente = modelos_promedio$numero_de_cliente,
                                  Predicted = modelos_promedio$Predicted)
write.csv(kaggle_hibrido_9500_modelos_1_3_7_8_10_11_12,
          "kaggle_hibrido_9500_modelos_1_3_7_8_10_11_12.csv", row.names = FALSE)

modelos_promedio$Predicted <- c(rep(1, 10000), rep(0, 165644-10000))
kaggle_hibrido_10000_modelos_1_3_7_8_10_11_12 <- data.table(numero_de_cliente = modelos_promedio$numero_de_cliente,
                                   Predicted = modelos_promedio$Predicted)
write.csv(kaggle_hibrido_10000_modelos_1_3_7_8_10_11_12,
          "kaggle_hibrido_10000_modelos_1_3_7_8_10_11_12.csv", row.names = FALSE)


modelos_promedio$Predicted <- c(rep(1, 10500), rep(0, 165644-10500))
kaggle_hibrido_10500_modelos_1_3_7_8_10_11_12 <- data.table(numero_de_cliente = modelos_promedio$numero_de_cliente,
                                   Predicted = modelos_promedio$Predicted)
write.csv(kaggle_hibrido_10500_modelos_1_3_7_8_10_11_12,
          "kaggle_hibrido_10500_modelos_1_3_7_8_10_11_12.csv", row.names = FALSE)

modelos_promedio$Predicted <- c(rep(1, 11000), rep(0, 165644-11000))
kaggle_hibrido_11000_modelos_1_3_7_8_10_11_12 <- data.table(numero_de_cliente = modelos_promedio$numero_de_cliente,
                                   Predicted = modelos_promedio$Predicted)
write.csv(kaggle_hibrido_11000_modelos_1_3_7_8_10_11_12,
          "kaggle_hibrido_11000_modelos_1_3_7_8_10_11_12.csv", row.names = FALSE)


modelos_promedio$Predicted <- c(rep(1, 11500), rep(0, 165644-11500))
kaggle_hibrido_11500_modelos_1_3_7_8_10_11_12 <- data.table(numero_de_cliente = modelos_promedio$numero_de_cliente,
                                   Predicted = modelos_promedio$Predicted)
write.csv(kaggle_hibrido_11500_modelos_1_3_7_8_10_11_12,
          "kaggle_hibrido_11500_modelos_1_3_7_8_10_11_12.csv", row.names = FALSE)


modelos_promedio$Predicted <- c(rep(1, 12000), rep(0, 165644-12000))
kaggle_hibrido_12000_modelos_1_3_7_8_10_11_12 <- data.table(numero_de_cliente = modelos_promedio$numero_de_cliente,
                                   Predicted = modelos_promedio$Predicted)
write.csv(kaggle_hibrido_12000_modelos_1_3_7_8_10_11_12,
          "kaggle_hibrido_12000_modelos_1_3_7_8_10_11_12.csv", row.names = FALSE)

modelos_promedio$Predicted <- c(rep(1, 12500), rep(0, 165644-12500))
kaggle_hibrido_12500_modelos_1_3_7_8_10_11_12 <- data.table(numero_de_cliente = modelos_promedio$numero_de_cliente,
                                   Predicted = modelos_promedio$Predicted)
write.csv(kaggle_hibrido_12500_modelos_1_3_7_8_10_11_12,
          "kaggle_hibrido_12500_modelos_1_3_7_8_10_11_12.csv", row.names = FALSE)

#Subir los archivos a Kaggle manualmente

# Poner las ganancias de Kaggle del modelo hibrido
ganancia_hibrido_11 <- c(134.946, 133.897, 132.847, 134.596, 135.856, 132.427)
corte <- c(10000, 10500, 11000, 11500, 12000, 12500)
modelito_11 <- rep("hibrido__11", 6)
kaggle_hibrido_11 <- data.frame("corte" = corte, "ganancia" = ganancia_hibrido_11, "modelos" = modelito_11)

ganancia_hibrido_12 <- c(134.666, 136.556, 132.637, 134.317, 135.786, 132.847)
modelito_12 <- rep("hibrido__12", 6)
kaggle_hibrido_12 <- data.frame("corte" = corte, "ganancia" = ganancia_hibrido_12, "modelos" = modelito_12)


kaggle_modelos <- rbind(kaggle_modelos, kaggle_hibrido_11, kaggle_hibrido_12)
